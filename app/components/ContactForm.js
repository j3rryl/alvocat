  ...
  return (
    <form action="#" className="space-y-8">
        ...
        <div style={{
          ...
          <button type="submit" className="py-3 px-5 text-sm font-medium text-center text-gray-900 dark:text-gray-400 rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-primary-800 border border-gray-400">Send message</button>
      </form>
  )
}
